...
| [Qwen](https://qwenlm.github.io/)    | [Qwen2-72B-Instruct](https://huggingface.co/Qwen/Qwen2-72B-Instruct) |Language model by Alibaba specialized in understanding and generating text with high accuracy.                                                    | Open (Permissive) | Alibaba    | 2023-08      | Free |
