...
| [Command-R](https://cohere.com/) | a scalable AI model designed for enterprise-grade retrieval augmented generation (RAG) and tool use. | Proprietary   | Cohere      | unkown     | Freemium |
